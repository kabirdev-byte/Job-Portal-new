...
const AddJob = () => {
    ...
    const [location, setLocations] = useState('Bangalore')
    ...
    return (
        <form className='container p-4 flex flex-col w-full items-start gap-3'>
            ...
            <div className='w-full '>
                ...
                <input
                    type="text" name="" id="" placeholder='Type here'
            ...
            <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
                ...
                <div>
                    ...
                    <select className='w-full px-3 py-2 border-2 border-gray-300 rounded' onChange={e => setLocations(e.target.value)}>
