                    ...
                    <tbody>
                        {viewApplicationsPageData.map((applicant, index) => (
                            <tr key={index} className='text-gray-700'>
                                ...
                                <td className='py-2 border-gray-200 px-4 border-b max-sm:hidden'>{applicant.jobTitle}</td>
                                <td className='py-2 border-gray-200 px-4 border-b max-sm:hidden'>{applicant.location}</td>
