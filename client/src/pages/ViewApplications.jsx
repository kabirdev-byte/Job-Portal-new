                    ...
                    <table className='w-full max-w-4xl bg-white border border-gray-200 max-sm:text-sm'>
                        <thead>
                            <tr className='border-b border-gray-300'>
                                ...
                                <th className='py-2 px-4 text-left max-sm:hidden'>Locations</th>
                        ...
                        <tbody>
                            {applicants.filter(item => item.jobId && item.userId).map((applicant, index) => (
                                <tr key={index} className='text-gray-700'>
                                    ...
                                    <td className='py-2 border-gray-200 px-4 border-b max-sm:hidden'>{applicant.jobId.jobTitle}</td>
                                    <td className='py-2 border-gray-200 px-4 border-b max-sm:hidden'>{applicant.jobId.location}</td>
